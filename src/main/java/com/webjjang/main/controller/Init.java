...
import com.webjjang.member.service.MemberChageGradeNoService;
...
public class Init {
	...
	static {
		...
		serviceMap.put("/member/changeGrade.do", new MemberChageGradeNoService());
		...
		serviceMap.get("/ajax/getNewMsgCnt.do").setDAO(daoMap.get("memberDAO"));
