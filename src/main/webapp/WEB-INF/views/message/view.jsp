		...
		<div class="card">
			  <div class="card-header">
			   <div class="media border p-3">
				  <img src="${vo.sendPhoto }" alt="이미지없음" class="mr-3 mt-3 rounded-circle" style="width:60px;">
		  ...
		  <div class="card-footer">
			...
			<a href="/message/list.do?${pageObject.pageQuery }&mode=${param.mode}"class="btn btn-dark">리스트</a>
		</div>
		</div>
	  </c:if>
	<c:if test="${param.accept!=1}">
	<h3>${(param.accept!=1)?"받은":"보낸" } 메세지 보기</h3>
		<div class="card">
			  <div class="card-header">
			   <div class="media border p-3">
				  <img src="${vo.sendPhoto }" alt="이미지없음" class="mr-3 mt-3 rounded-circle" style="width:60px;">
